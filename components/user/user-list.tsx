          ...
          <tbody className="[&_tr:last-child]:border-0">
            {users.map((user) => (
              ...
              >
                ...
                <td className="p-4 align-middle text-xs">{new Date(user.createdAt).toLocaleString()}</td>
                <td className="p-4 align-middle text-xs">{new Date(user.updatedAt).toLocaleString()}</td>
                <td className="p-4 align-middle">
