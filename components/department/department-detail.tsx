      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <Button onClick={onEdit}>
            <Edit className="mr-1 h-4 w-4" /> Edit Department
          </Button>
                ...
                {department.roles.map((role, index) => (
                  <div key={role.id} className="rounded-md border p-6 dark:border-slate-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div>
                        <h5 className="text-sm font-medium">Department ID</h5>
                        <p className="text-sm text-muted-foreground font-mono">{role.departmentId}</p>
                      </div>
                      <div>
                        <h5 className="text-sm font-medium">Is Active</h5>
                        <p
                          className={`text-sm ${role.isActive ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
                        >
